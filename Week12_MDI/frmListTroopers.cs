...
{
    public partial class frmListTroopers : Form
    {
        public frmListTroopers()
        {
            InitializeComponent();
        }
        ...
        public static frmListTroopers Instance
        {
            get
            {
                if (trooperListInstance == null)
                    trooperListInstance = new frmListTroopers();
                return trooperListInstance;
            }
        }

        private void form_closed(object sender, FormClosedEventArgs e)
        {
            trooperListInstance = null; //Setting trooper instance to null
        }
        ...
        private void PopulateTroopers()
        {
            ...
            frmMDIParent frm = (frmMDIParent)this.MdiParent;
            frm.SetNumTroopers(Troopers.Count);
        }
