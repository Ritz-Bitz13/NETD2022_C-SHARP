...
namespace Week12_MDI
{
    public partial class frmAddEdit : Form
    {
        ...
        private void SaveTrooper()
        {
            ...
            if (Trooper.TrooperExists(frmListTroopers.Troopers, t.Designation))
            {
                Trooper FoundTrooper = Trooper.FindTrooper(frmListTroopers.Troopers, t.Designation);
                frmListTroopers.Troopers.Remove(FoundTrooper);
            }

            frmListTroopers.Troopers.Add(t);
        }
